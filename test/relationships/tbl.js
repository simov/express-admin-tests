...
describe('tbl', () => {
  before((done) => {
    async.eachSeries(['tbl','mto1','mto2',
      ...
      'mto2_has_mtm1', 'mto2_has_mtm2'], (table, done) => {
      client.truncate(table, done)
    }, () => {
      $('a[href$="/tbl"]')[0].click()
      page.load(done)
    })
  ...
  it.skip('delete all records', (done) => {
  ...
  it('remove first mto1 inline and add another', (done) => {
